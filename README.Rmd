...
Edit `SMI205_Assessment2_Template` by adding pieces of your work into it. It is a template prepared to help you to write a transparent research report. Your job is to make your research fully reproducible.

Publish it on as a reproducible report on Rpubs and create project repository on Github (optional).

> Use you student number to name your Rpubs and Github accounts so your work is anonymous.

## 1.1. Your Workflow 

As with other project, organise your work transparently into a hierarchy of folders.
...
You should not be republishing data that you have not created or edited to creat a new version of a dataset. 
